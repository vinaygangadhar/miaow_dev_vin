...
{
      25,     0,    -1,    -1,    26,    25,    -1,    20,    -1,    27,
      20,    -1,    28,    20,    -1,     9,    11,    -1,     9,    29,
      -1,    -1,    31,    -1,    31,    10,    29,    -1,     3,    -1,
       4,    -1,     5,    -1,     6,    -1,     7,    -1,     8,    -1,
      30,    -1,     9,    16,     6,    11,     6,    17,    -1,    22,
      18,    31,    19,    -1,    23,    31,    -1,    30,    32,    12,
      11,    16,     9,    10,     9,    17,    -1,     9,    -1,    33,
      -1,    -1,    32,    13,    -1,    32,    14,    -1,    32,    15,
      11,     6,    -1,    34,    -1,    34,    21,    33,    -1,     9,
      18,     6,    19,    -1
};
...
{
       0,   100,   100,   102,   106,   108,   110,   122,   148,   169,
     173,   187,   200,   206,   212,   218,   223,   232,   239,   244,
     283,   307,   331,   356,   379,   388,   392,   403,   414,   427,
     429,   453
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$accept", "rl_input", "rl_line", "rl_label", "rl_instr", "rl_arg_list",
  "rl_operand", "rl_arg", "rl_maddr_qual", "rl_waitcnt_arg",
  "rl_waitcnt_elem", 0
};
#endif
...
{
       2,     9,     4,     0,     2,     0,     0,    12,    13,    14,
      15,    16,    17,    23,     7,     0,     0,     8,    25,    10,
      24,    29,     1,     3,     5,     6,     0,     0,     0,    21,
       0,     9,     0,     0,     0,     0,     0,    26,    27,     0,
      11,     0,    30,     0,    31,    20,     0,     0,     0,     0,
      28,    19,     0,     0,     0,    22
};
...
{
       7,    -3,   -14,    21,     7,   -13,    14,   -14,   -14,   -14,
     -14,   -14,   -14,    17,   -14,    -1,     6,   -14,    12,    26,
     -14,    16,   -14,   -14,   -14,   -14,    32,    33,     6,   -14,
      11,     6,    31,    30,    23,    24,    34,   -14,   -14,    35,
     -14,    29,   -14,    38,   -14,   -14,    36,    42,    37,    40,
     -14,   -14,    41,    44,    39,   -14
};
...
{
       7,     8,     9,    10,    11,    12,    13,    24,    14,     7,
       8,     9,    10,    11,    12,    13,     1,    28,    29,    15,
      16,    22,   -18,    36,    37,    38,    39,     2,    15,    16,
      35,   -18,   -18,    26,    25,    27,    31,    32,    33,    34,
      41,    43,    44,    45,    48,    46,    47,    27,    50,    52,
      23,    53,    49,    54,    51,     0,    55,    42,    40
};
...
{
       3,     4,     5,     6,     7,     8,     9,    20,    11,     3,
       4,     5,     6,     7,     8,     9,     9,    18,    16,    22,
      23,     0,    10,    12,    13,    14,    15,    20,    22,    23,
      28,    19,    20,    16,    20,    18,    10,    21,     6,     6,
       9,    11,    19,    19,     6,    11,    11,    18,     6,     9,
       4,    10,    16,     9,    17,    -1,    17,    32,    31
};
...
{
       0,     9,    20,    25,    26,    27,    28,     3,     4,     5,
       6,     7,     8,     9,    11,    22,    23,    29,    30,    31,
      33,    34,     0,    25,    20,    20,    16,    18,    18,    31,
      32,    10,    21,     6,     6,    31,    12,    13,    14,    15,
      29,     9,    33,    11,    19,    19,    11,    11,     6,    16,
       6,    17,     9,    10,     9,    17
};
...
#line 111 "parser.y"
    {
		struct si_dis_inst_t *inst = (yyvsp[(1) - (2)].inst);
...
#line 123 "parser.y"
    {
		struct si_id_t *id = (yyvsp[(1) - (2)].id);
...
#line 201 "parser.y"
    {
		(yyval.arg) = si_arg_create_scalar_register((yyvsp[(1) - (1)].id)->name);
		si_id_free((yyvsp[(1) - (1)].id));
	}
    break;
...
#line 207 "parser.y"
    {
		(yyval.arg) = si_arg_create_vector_register((yyvsp[(1) - (1)].id)->name); 
		si_id_free((yyvsp[(1) - (1)].id));
	}
    break;
...
#line 213 "parser.y"
    {
		(yyval.arg) = si_arg_create_special_register((yyvsp[(1) - (1)].id)->name); 
		si_id_free((yyvsp[(1) - (1)].id));
	}
    break;
...
#line 219 "parser.y"
    {
		(yyval.arg) = si_arg_create_literal((yyvsp[(1) - (1)].num));
	}
    break;
...
#line 224 "parser.y"
    {
		...
		(yyval.arg) = si_arg_create_literal(value); 
		si_id_free((yyvsp[(1) - (1)].id));
	}
    break;
...
#line 233 "parser.y"
    {
		(yyval.arg) = si_arg_create_literal_float((yyvsp[(1) - (1)].num_float));
	}
    break;
...
#line 284 "parser.y"
    {
		struct si_arg_t *arg = (yyvsp[(3) - (4)].arg);
...
#line 308 "parser.y"
    {
		struct si_arg_t *arg = (yyvsp[(2) - (2)].arg);
...
#line 388 "parser.y"
    {
		(yyval.arg) = si_arg_create_maddr_qual();
	}
    break;
...
#line 393 "parser.y"
    {
		struct si_arg_t *qual = (yyvsp[(1) - (2)].arg);
...
#line 415 "parser.y"
    {
		struct si_arg_t *qual = (yyvsp[(1) - (4)].arg);
