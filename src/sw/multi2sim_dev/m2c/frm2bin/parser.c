...
{
       0,    87,    87,    88,    92,    93,    97,   101,   102,   106,
     110,   127,   176,   177,   181,   185,   186,   190,   211,   212,
     216,   220,   221,   225,   261,   265,   289,   311,   315,   329,
     338,   344,   350,   356,   362,   367,   378,   385,   413,   424,
     438,   448,   456,   464
};
#endif
...
#line 191 "parser.y"
    {
		...
		size = (atoi(((yyvsp[(1) - (2)].id)->name) + 2)) / 8;
